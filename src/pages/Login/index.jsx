    ...
    return (
        <div className="flex h-screen">
            <div className="h-full w-1/2 bg-white shadow-[0_4px_44px_0px_rgba(0,0,0,0.25)] flex flex-col items-center justify-center">
                <div className="h-12 w-12 bg-[url('assets/logo.png')] bg-cover hover:cursor-pointer"></div>
                <page.form onChange={handleStateChange} />
            </div>
            <div className="h-full w-1/2 flex justify-start items-center bg-gradient-to-tl from-rose-500 to-blue-600">
